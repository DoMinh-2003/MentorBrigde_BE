...
public class StudentServiceImpl implements StudentService {
    ...
    @Override
    public Page<UserResponse> getStudentsByFullNameContaining(String fullName, int offset, int size, String sortBy) {
        // Check offset
        pageUtil.checkOffset(offset);
        // Create pageable with offset -1 (default in controller is 1)
        Pageable pageable = pageUtil.getPageable(offset - 1, size,sortBy);
    ...
    @Override
    public Page<UserResponse> getStudentsByStudentCode(String studentCode, int offset, int size, String sortBy){
        // Check offset
        pageUtil.checkOffset(offset);
        // Create pageable with offset -1 (default in controller is 1)
        Pageable pageable = pageUtil.getPageable(offset - 1, size,sortBy);
